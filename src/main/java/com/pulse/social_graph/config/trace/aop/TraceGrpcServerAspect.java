package com.pulse.social_graph.config.trace.aop;

import com.pulse.social_graph.config.grpc.interceptor.GrpcMetadata;
...
public class TraceGrpcServerAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around("@annotation(com.pulse.social_graph.config.trace.annotation.TraceGrpcServer)")
    public Object traceGrpcServer(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Span span = tracer.spanBuilder("SocialGraph [grpc] server response")
