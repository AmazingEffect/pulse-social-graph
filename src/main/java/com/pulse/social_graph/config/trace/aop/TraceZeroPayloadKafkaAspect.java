...
public class TraceZeroPayloadKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(com.pulse.social_graph.config.trace.annotation.TraceZeroPayloadKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("SocialGraph [kafka-consume] zeropayload gRPC call")
