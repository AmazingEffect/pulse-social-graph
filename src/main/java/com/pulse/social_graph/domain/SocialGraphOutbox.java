...
@NoArgsConstructor
@Getter
public class SocialGraphOutbox {
    ...
    // factory method
    public static SocialGraphOutbox of(String eventType, Long payload, String nowTraceId, MessageStatus messageStatus) {
        return SocialGraphOutbox.builder()
                .eventType(eventType)
                .payload(payload)
                .traceId(nowTraceId)
