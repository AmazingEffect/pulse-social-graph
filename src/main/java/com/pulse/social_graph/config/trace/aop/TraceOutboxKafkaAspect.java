...
public class TraceOutboxKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(com.pulse.social_graph.config.trace.annotation.TraceOutboxKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("SocialGraph [kafka-consume] outbox process change [PROCESSED]")
